...
public class DashBoardController {
	...
	public Mono<AgentStatsDto> getAgentSummaryStats(@PathVariable String agentId) {
		return dashboardService.getAgentStatsById(agentId);
	}

	@GetMapping("/stats")
	public Flux<AgentStatsDto> getAllAgentStats() {
		return dashboardService.getAllAgentStats();
	}
